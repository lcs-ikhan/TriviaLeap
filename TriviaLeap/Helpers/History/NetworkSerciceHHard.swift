...
//  TriviaLeap
//
//  Created by Isaad Khan on 2023-06-04.
//


import Foundation

struct NetworkServiceHHard {
    ...
    static func fetch() async -> [Trivia] {
        ...
        let endpoint = "https://opentdb.com/api.php?amount=1&category=23&difficulty=hard&type=boolean"
